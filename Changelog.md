...
- Add `test.extraShock` and `test.extraWounds` as additional changes allowed in Active Effects, to modify the amount of wounds/shock generated by the attack.
- Add `targetSelf` flag to the list of fields for a Test.
